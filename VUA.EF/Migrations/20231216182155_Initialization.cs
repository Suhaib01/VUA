    ...
    public partial class Initialization : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViduoUrls", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false),
                    WeekId = table.Column<int>(type: "int", nullable: false),
                    ViduoUrlid = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_weekVideoUrls", x => new { x.WeekId, x.id });
                    table.ForeignKey(
                        name: "FK_weekVideoUrls_ViduoUrls_ViduoUrlid",
                        column: x => x.ViduoUrlid,
                        principalTable: "ViduoUrls",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_weekVideoUrls_ViduoUrls_id",
                        column: x => x.id,
                        principalTable: "ViduoUrls",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_weekVideoUrls_Weeks_WeekId",
                        column: x => x.WeekId,
                        principalTable: "Weeks",
                        principalColumn: "WeekId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_weekVideoUrls_id",
                table: "weekVideoUrls",
                column: "id");

            migrationBuilder.CreateIndex(
                name: "IX_weekVideoUrls_ViduoUrlid",
                table: "weekVideoUrls",
                column: "ViduoUrlid");
        }
